        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mCurrentMode == ActionMode.DELETE && mHandlingSticker != null) {
                    ...
                    BokehEffectActivity.drawables_sticker.remove(Share.STICKER_POSITION);
                    Log.e("Avail Sticker", BokehEffectActivity.drawables_sticker.size() + "");

                    if (BokehEffectActivity.drawables_sticker.size() == 0) {
